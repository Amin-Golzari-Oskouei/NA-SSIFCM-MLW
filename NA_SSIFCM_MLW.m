function [Cluster_elem,M,W,Z]=NA_SSIFCM_MLW(X,M,k,p_init,p_max,p_step,t_max,beta_memory,N,fuzzy_degree,d,q,landa,f,b,alpha2, alpha1,Neig, NR, beta, sample_weight)
%
%
%Function Inputs
%===============
